...
library(SASmarkdown)
source("setup/hilang.r")
saspath <- "C:/Program Files/SASHome/SASFoundation/9.4/sas.exe"
sasopts <- "-nosplash -ls 75"
knitr::opts_chunk$set(engine.path=saspath, engine.opts=sasopts)
...
```{r block-1, eval=FALSE, hilang="sas"}
...
```{r block-2, eval=FALSE, hilang="sas"}
...
```{r block-3, eval=FALSE, hilang="sas"}
...
```{r block-4, eval=FALSE, hilang="sas"}
...
```{r block-5, eval=FALSE, hilang="sas"}
...
```{r block-6, eval=FALSE, hilang="sas"}
